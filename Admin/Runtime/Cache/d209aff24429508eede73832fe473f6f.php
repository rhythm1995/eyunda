                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>发货日期</th>
                                                <th>当前状态</th>
                                                <th>操作</th><!--三种状态：等待中的，正在进行的，已完成的-->
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><tr>
                                                <td><?php echo ($g["id"]); ?></td>
                                                <td><?php echo ($g["from"]); ?>-<?php echo ($g["to"]); ?></td>
                                                <td><?php echo ($g["goodname"]); ?></td>
                                                <td><?php echo ($g["carname"]); ?></td>
                                                <td><?php echo ($g["data"]); ?></td>
                                                <td><?php echo ($g["zhuangtai"]); ?></td>
                                                <td><a href="Detil/id/<?php echo ($g["id"]); ?>.html">详情</a></td>
