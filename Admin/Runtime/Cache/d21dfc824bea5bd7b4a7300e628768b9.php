                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <div class="col-md-2">
                                    <form action="Search" method="GET" id="sskey">
                                        <input name='key' onchange="forsearch()" class="form-control" id="search_user" placeholder="输入查找关键字" type="text">
									</form>
                                    </div>
                                    <div>
                                        <button onclick="forsearch()" type="button" class="btn btn-info">查找</button>
                                    </div>
                                    <script type="text/javascript">
                                    var forsearch = function(){
                                    	document.getElementById('sskey').submit();
                                    }
                                    </script>
                                </div>
                                   ...
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <th><?php echo ($u["createtime"]); ?></th>
                                                <th><a href="Detil/id/<?php echo ($u["id"]); ?>.html">详情</a></th>
