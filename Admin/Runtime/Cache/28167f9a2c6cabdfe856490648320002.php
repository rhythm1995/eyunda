    ...
    <div class="page-sidebar sidebar">
        <div class="page-sidebar-inner slimscroll">
            ...
            <ul class="menu accordion-menu">
                ...
                <li class="active"><a href="__ROOT__/admin.php/User/index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>用户管理</p></a></li>
                <li><a href="__ROOT__/admin.php/Car/index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-scale"></span><p>车辆管理</p></a>
                ...
                <li><a href="__ROOT__/admin.php/News/index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th"></span><p>咨询发布</p></a>
                <li><a href="__ROOT__/admin.php/Shenhe/index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-edit"></span><p>车辆审核</p></a>
            </ul>
            ...
            <div class="page-inner">
                ...
                <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><h3><a href="__ROOT__/admin.php/User/index">用户管理</a>/<?php echo ($u["id"]); ?></h3><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                        ...
                                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><div class="col-md-3" >
                                            <div class="controls">
                                                <label for="showEasing" style="float: left">用户名:</label>
                                                <label for="showEasing" ><?php echo ($u["username"]); ?></label>

                                                <label for="showEasing" style="float: left">用户ID:</label>
                                                <label for="showEasing"><?php echo ($u["id"]); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3" >
                                            <div class="controls">
                                                <label for="hideEasing" style="float: left">用户手机号:</label>
                                                <label for="hideEasing"><?php echo ($u["phone"]); ?></label>

                                                <label for="hideEasing" style="float: left">用户注册日期:</label>
                                                <label for="hideEasing"><?php echo ($u["createtime"]); ?></label>
                                            </div>
                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php if(is_array($count)): $i = 0; $__LIST__ = $count;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><div class="col-md-3" >
                                            <div class="controls">
                                                <label for="showMethod" style="float: left">发单量:</label>
                                                <label for="showMethod"><?php echo ($c["goods"]); ?></label>

                                                <label for="showMethod" style="float: left">发车量:</label>
                                                <label for="showMethod"><?php echo ($c["cars"]); ?></label>
                                            </div>
                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><div class="col-md-3" >
                                            <div class="controls">
                                                <a href="__ROOT__/admin.php/User/Del/id/<?php echo ($u["id"]); ?>.html">删除用户</a><br>
                                                <a href="__ROOT__/admin.php/User/Change/id/<?php echo ($u["id"]); ?>.html">取消车主</a>
                                            </div>
                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <table class="table">
                                            ...
                                            <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><tr>
                                                <th scope="row"><?php echo ($g["xuhao"]); ?></th>
                                                <td><?php echo ($g["id"]); ?></td>
                                                <td><?php echo ($g["goodname"]); ?></td>
                                                <td><?php echo ($g["createtime"]); ?></td>
                                                <td><?php echo ($g["from"]); ?></td>
                                                <td><?php echo ($g["to"]); ?></td>
                                                <td><a href="__ROOT__/admin.php/Yundan/Detil/id/<?php echo ($g["id"]); ?>.html">查看</a></td>
