...
<body style="background:rgb(245,245,245);margin:0px;">
    ...
    <div style="margin:0px;width:100%;float:left;padding-left:10%;padding-right:10%;box-shadow:1px 0px 1px 2px rgb(27,154,247);margin-top:-20px;padding-top:20px;padding-bottom:10px;">
        <div style="width:100%;float:left;padding:5px;box-shadow:0px 0px 2px 1px #ddd;background:#fff;">
            <p style="color:RGB(27,154,247);margin:0px;">发布车源</p>
            <hr style="width:100%;margin-top:5px;">
            <div style="width:100%;float:left;">
                <form id="fabu" class="form-horizontal" action="cars_do.html" method="POST" role="form">
                    <div style="width:100%;float:left;margin:0px;">
                    <p style="width:100%;margin-left:10px;margin-top:0px;">车辆信息</p>
                    <select name="chexing" style="width:30%;float:left;height:34px;border-radius:5px;border:none;box-shadow:0px 0px 1px 1px #f3f3f3 inset;border:solid 1px #d3d3d3;color:#a3a3a3;margin-left:10px;" >
                        <option>车型</option>
                        <option value="平板车">平板车</option>
                        <option value="高栏车">高栏车</option>
                        <option value="工程车">工程车</option>
                        <option value="集装箱运输车">罐车</option>
                        <option value="冷藏车">冷藏车</option>
                        <option value="面包车">面包车</option>
                        <option value="爬梯车">爬梯车</option>
                        <option value="商品车运输车">商品车运输车</option>
                        <option value="厢式货车">厢式货车</option>
                        <option value="自卸车">自卸车</option>
                        <option value="其他">其他</option>
                    </select>
                    <input name="zaizhong" style="width:30%;float:left;margin-left:10px;" class="form-control" placeholder="载重（吨）">
                    </div>
                    <div style="width:100%;float:left;margin-top:10px;">
                    <input name="cheling" style="width:30%;float:left;margin-left:10px;" class="form-control" placeholder="车龄（年）">
                    <input name="banchang" style="width:30%;float:left;margin-left:10px;" class="form-control" placeholder="板长（米）">
                    </div>
                    <div style="width:100%;float:left;margin-top:10px;margin-bottom:10px;">
                    </div>
                    <hr style="width:100%;">
                    <p style="width:100%;margin-left:10px;margin-top:0px;">路线（出发地---目的地）</p>
                    <div style="width:100%;float:left;margin-top:10px;margin-bottom:10px;">
                    ...
                    <hr style="width:100%;">  
                     <p style="width:100%;margin-left:10px;margin-top:0px;">发车时间</p>
